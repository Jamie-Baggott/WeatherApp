...
public class MainActivityDark extends AppCompatActivity {
            ...
            for (int i = 0; i < 1; ++i) {
                ...
                saveBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        DbHandler dbHandler = new DbHandler(MainActivityDark.this);
                        dbHandler.insertUserDetails(cityName, weatherStatus, currentTemp, minTemp, maxTemp);
                        intent = new Intent(MainActivityDark.this, DetailsActivityDark.class);
                ...
                homeBtn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        intent = new Intent(MainActivityDark.this, IntroActivityDark.class);
                        startActivity(intent);
                    }
                });
    ...
    public void connectWeather(){
        ...
        RequestQueue rQueue = Volley.newRequestQueue(MainActivityDark.this);
        rQueue.add(request);
